...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/termgraph-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8300&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/termgraph-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `termgraph` can be installed with:

```
conda install termgraph
```

It is possible to list all of the versions of `termgraph` available on your platform with:
